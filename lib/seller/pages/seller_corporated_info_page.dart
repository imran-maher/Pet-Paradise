...
class SellerCorporatedInfoPage extends StatefulWidget {
  ...
  @override
  State<SellerCorporatedInfoPage> createState() => _SellerCorporatedInfoPageState();
}

class _SellerCorporatedInfoPageState extends State<SellerCorporatedInfoPage> {
  @override
  Widget build(BuildContext context) {
    return customBodyWithCenterTextAppBar(context: context, appBarTitle: "CORPORATED INFORMATION", responsiveScreens: Responsive(mobile: mobile(context), tablet: tablet(context), web: web(context)));
  }
